...
type MessageRouterFunc func(msg ServiceMessage) ServiceType
...
type BrokerImplementation struct {
	...
	messageRouter  MessageRouterFunc
}
...
func NewBroker(messageRouterFunc MessageRouterFunc) MessageBroker {
